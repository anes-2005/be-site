// Algeria administrative data: 58 wilayas and their communes (municipalities).
// Source: official Algerian Interior Ministry division (58 wilayas, 1541 communes).
// Wilaya English names follow the project canonical list in src/lib/wilayas.ts.
...
export const MUNICIPALITIES: Record<string, string[]> = {
  ...
  'Laghouat': ['El Beidha', 'Gueltat Sidi Saad', 'Brida', 'Ain Sidi Ali', 'Tadjemout', 'Hadj Mechri', 'Taouiala', 'El Ghicha', 'Tadjrouna', 'Sebgag', 'Sidi Bouzid', 'Oued Morra', 'Laghouat', 'Oued M\'zi', 'Ksar El Hirane', 'El Assafia', 'Sidi Makhlouf', 'Hassi Delaa', 'Hassi R\'mel', 'Ain Madhi', 'El Haouaita', 'Kheneg', 'Benacer Benchohra', 'Aflou'],
  ...
  'Tébessa': ['El-Houidjbet', 'El-Aouinet', 'Ferkane', 'Negrine', 'Bir Mokkadem', 'Bir Dheheb', 'Saf Saf El Ouesra', 'Guorriguer', 'Bekkaria', 'Boulhaf Dyr', 'Oum Ali', 'Boukhadra', 'El Malabiod', 'Ouenza', 'El Meridj', 'Ain Zerga', 'Stah Guentis', 'El Ogla', 'El Mezeraa', 'Bedjene', 'Morsott', 'Telidjen', 'Cheria', 'El Ogla El Malha', 'Bir-El-Ater', 'Tebessa', 'Hammamet', 'El Kouif'],
  ...
  'Tiaret': ['Mahdia', 'Ain Dzarit', 'Sebaine', 'Faidja', 'Si Abdelghani', 'Sougueur', 'Tousnina', 'Meghila', 'Sebt', 'Sidi Hosni', 'Ain El Hadid', 'Frenda', 'Takhemaret', 'Ain Kermes', 'Djebilet Rosfa', 'Madna', 'Medrissa', 'Sidi Abderrahmane', 'Ksar Chellala', 'Guertoufa', 'Serghine', 'Zmalet El Emir Abdelkade', 'Oued Lilli', 'Sidi Ali Mellal', 'Djillali Ben Amar', 'Mechraa Safa', 'Tagdempt', 'Bougara', 'Hamadia', 'Rechaiga', 'Tidda', 'Nadorah', 'Tiaret', 'Medroussa', 'Mellakou', 'Sidi Bakhti', 'Ain Deheb', 'Chehaima', 'Naima', 'Ain Bouchekif', 'Dahmouni', 'Rahouia'],
